...
[David Altare](https://github.com/daltare) $\bullet$ [Daniel Ovando]() $\bullet$ [Julie Lowndes, Jamie Montgomery, and Juliet Verstaen](https://github.com/OHI-Northeast/ne-dashboard)<br>  [OceanAdapt](https://oceanadapt.rutgers.edu) $\bullet$ [ROpenSci](https://ropensci.org) $\bullet$ [Mike Johnson](https://github.com/mikejohnson51)
