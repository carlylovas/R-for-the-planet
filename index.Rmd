...
# How environmental data scientists use R 
...
1. Facilitating methodological transparency: The Ocean Health Index [dashboard](https://ohi-northeast.shinyapps.io/ne-dashboard/), [code](https://github.com/ohi-northeast/ne-dashboard)
...
Want to try your hand at mapping historical temperature data in Europe? [Give it a go.](https://github.com/afredston/R-for-the-planet/blob/main/demo.Rmd)
...
Featured code made open source by:

[David Altare](https://github.com/daltare) $\bullet$ [Daniel Ovando]() $\bullet$ [Jamie Montgomery](https://github.com/OHI-Northeast/ne-dashboard) $\bullet$ [OceanAdapt](https://oceanadapt.rutgers.edu) $\bullet$ [ROpenSci](https://ropensci.org) $\bullet$ [Mike Johnson](https://github.com/mikejohnson51)
